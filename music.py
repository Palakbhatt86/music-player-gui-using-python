...
def get_icon():
    winicon = PhotoImage(file="decor.png")
...
img = PhotoImage(file="HWALLP.png", width=500, height=460)
lab = Label(root)
lab.grid()
lab["compound"] = LEFT
lab["image"] = img
...
button_load_music = Button(root, text="♫ Click Here To Load The Song ♫", width=43,
